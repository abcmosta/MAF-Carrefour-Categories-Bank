...
export default function SearchControls({
  ...
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs p-5 mb-6" id="search-controls-container">
      <div className="flex items-center gap-2 pb-3 border-b border-slate-100 mb-4">
        <Settings className="w-4 h-4 text-slate-500" />
        <h2 className="text-sm font-semibold text-slate-800">Search Options & Column Configuration</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Match Mode Settings */}
        <div className="space-y-3.5">
          <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Match Parameters</p>
          <div className="space-y-2.5">
            <label className="flex items-start gap-3 cursor-pointer select-none group">
              <input
                ...
                className="mt-0.5 rounded-sm border-slate-300 text-emerald-600 focus:ring-emerald-500 cursor-pointer w-4 h-4"
              />
              <div className="text-sm">
                <span className="font-medium text-slate-700 group-hover:text-slate-900 transition-colors">Case Sensitive</span>
                <p className="text-xs text-slate-400">Match exact casing of query words</p>
              </div>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer select-none group">
              ...
              />
              <div className="text-sm">
                <span className="font-medium text-slate-700 group-hover:text-slate-900 transition-colors">Exact Cell Match</span>
                <p className="text-xs text-slate-400">Cell contents must match query entirely</p>
              </div>
            </label>
          </div>
        </div>
        ...
        <div className="space-y-3.5">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Search In</p>
              ...
              return (
                ...
                >
                  ...
                  {isChecked ? (
                    ...
                    <span className="text-[10px] text-slate-400 font-medium bg-slate-100 px-1.5 py-0.5 rounded-sm">Active</span>
                  ) : null}
                </button>
              );
            })}
        ...
        <div className="space-y-3.5">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Visible Columns</p>
